...
* Reescrever a metodologia para explicar o hipercubo e erros tipo M e S, e também o critério de parcimônia do Arnold. (FEITO)
* Atualizar os resultados (rever os padrões, incluir descrição dos erros M e S) (A fazer)
* Rever material suplementar (A FAZER)
* Rever discussão (não deve precisar mudar muita coisa) (A FAZER)
...
* Funções para realizar as simulações e gráficos deste documento. A funções das simulações têm comentários em formato Roxygen que podem gerar uma página de ajuda. Lá há mais detalhes sobre as simulações: [functions.R](functions.R)
...
* Códigos para as figuras definitivas para o artigo: [final_plots.R](final_plots.R). Já subi as figuras em pdf no Overleaf e incluí no documento. O código gera os mesmos pdfs que estão lá.
...
* [tresults.RData](simulations/tresults.RData)
* [corresults.RData](simulations/corresults.RData)
* [anovaresults.RData](simulations/anovaresults.RData)
* [lmresults.RData](simulations/lmresults.RData)
