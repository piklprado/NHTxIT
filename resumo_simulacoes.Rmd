...
* Nos casos de ausência de efeito (H0 correta), considerei corretas
  ...
  hieeraquia (nested), incluindo o nulo. Nestes casos o usuário também
...
mostram o poder de cada procedimento. Em seguida uma tabela
com as probabilidades de conclusão correta nos casos em que H0 é verdadeira.
...
suplementar, porque não há muita variação importante. 


```{r type-I error}
p1b(t.results0, H0=TRUE)
p1b(t.results0, legend=FALSE, AIC2=FALSE, H0=TRUE, main="t-test", colours=c("black", "red"))
legend("bottomright",
               c("NHT",
                 expression(paste(Delta,"AIC = 0"))),
       pch=19, col=c("black", "red"), bty="n")
p1b(cor.results0, legend=FALSE, AIC2=FALSE, H0=TRUE, main="Correlation", colours=c("black", "red"))
p1b(anova.results0, legend=FALSE, AIC1=FALSE, H0=TRUE, main="Anova")
p1b(lm.results0, legend=FALSE, AIC1=FALSE, H0=TRUE, main="Linear regression, no collinearity")
p1b(lm.colin.results0, legend=FALSE, AIC1=FALSE, H0=TRUE, main="Linear regression, collinearity")
```
...
* Escolher as figuras que vão para o texto principal e material suplementar
...
* Critério 2 permanece como critério 1 e dAIC  dos demais >2
