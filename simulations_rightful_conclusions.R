...
q <- c("qunif", "qdunif")
## Arguments of each distribution (min and max values of the uniform distributions)
q.arg <- list(list(min=0.1, max=5), list(min=5, max=100))
## Accessory function for a single run with a combination of parameters
modelRun <- function (my.data) {
...
names(t.results0)[4:16] <- c("p.NHT.right", "p.AIC.right", "p.AIC.right.2", "p.mismatch", "p.mismatch.2", "mean.NHT.M",
                              "mean.AIC.M", "mean.AIC.M.2", "p.NHT.S",  "p.AIC.S", "p.AIC.S.2", "mean.pvalue", "mean.wH0")
...
q <- c("qunif", "qdunif")
## Arguments of each distribution (min and max values of the uniform distributions)
q.arg <- list(list(min=0.1, max=5), list(min=10, max=100))
## Accessory function for a single run with a combination of parameters
modelRun <- function (my.data) {
    return(mapply(sim.averages.null, my.data[,1], my.data[,2],
                  MoreArgs = list(nrep = nrepl, function.name="wp.cortest")))
...
clusterExport(cl, c("sim.averages.null"))
## Run the simulations 
myLHS20 <- LHS(modelRun.null, factors, nsampH, q, q.arg, cl=cl)
## dataframe with parameter values and results
cor.results0 <- cbind(get.data(myLHS20),  get.results(myLHS20))
names(cor.results0)[4:16] <- c("p.NHT.right", "p.AIC.right", "p.AIC.right.2", "p.mismatch", "p.mismatch.2", "mean.NHT.M",
                              "mean.AIC.M", "mean.AIC.M.2", "p.NHT.S",  "p.AIC.S", "p.AIC.S.2", "mean.pvalue", "mean.wH0")
##
...
clusterExport(cl, c("sim.averages.null"))
## Run the simulations 
myLHS30 <- LHS(modelRun.null, factors, nsampH, q, q.arg, cl=cl)
## dataframe with parameter values and results
anova.results0 <- cbind(get.data(myLHS30),  get.results(myLHS30))
names(anova.results0)[4:16] <- c("p.NHT.right", "p.AIC.right", "p.AIC.right.2", "p.mismatch", "p.mismatch.2", "mean.NHT.M",
                                "mean.AIC.M", "mean.AIC.M.2", "p.NHT.S",  "p.AIC.S", "p.AIC.S.2", "mean.pvalue", "mean.wH0")
save.image()
...
clusterExport(cl, c("sim.averages.null"))
## Run the simulations 
myLHS40 <- LHS(modelRun.null, factors, nsampH, q, q.arg, cl=cl)
## dataframe with parameter values and results
lm.results0 <- cbind(get.data(myLHS40),  get.results(myLHS40))
names(lm.results0)[4:16] <- c("p.NHT.right", "p.AIC.right", "p.AIC.right.2", "p.mismatch", "p.mismatch.2", "mean.NHT.M",
                              "mean.AIC.M", "mean.AIC.M.2", "p.NHT.S",  "p.AIC.S", "p.AIC.S.2", "mean.pvalue", "mean.wH0")
## 2. With colinearity
## Accessory function for a single run with a combination of parameters
modelRun <- function (my.data) {
...
## Hypercube sample of nsamp combinations of parameters
## Run the simulations 
myLHS50 <- LHS(modelRun.null, factors, nsampH, q, q.arg, cl=cl)
## dataframe with parameter values and results
lm.colin.results0 <- cbind(get.data(myLHS50),  get.results(myLHS50))
names(lm.colin.results0)[4:16] <- c("p.NHT.right", "p.AIC.right", "p.AIC.right.2", "p.mismatch", "p.mismatch.2", "mean.NHT.M",
                                   "mean.AIC.M", "mean.AIC.M.2", "p.NHT.S",  "p.AIC.S", "p.AIC.S.2", "mean.pvalue", "mean.wH0")
##
