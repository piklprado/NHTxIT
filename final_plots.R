...
p3b(t.results, main = "t-test", AIC2=FALSE, colours=c("black","grey","grey"),
    legend=FALSE, xlab="", ylab="", cex=0.25, xlim=c(0.1,3.5), log="xy")
...
p3b(anova.results, main = "ANOVA", AIC1=FALSE, colours=c("black","grey","grey"),
    legend=FALSE, xlab="", ylab="", cex=0.25,  xlim=c(0.1,3.5))
...
p4b(t.results, main = "t-test", AIC2=FALSE, colours=c("black","grey","grey"),
    legend=FALSE, xlab="", ylab="", cex=0.25, xlim=c(0.1,1.5))#, log="xy")
legend("topright",c("NHT","IT"), pch=19, col=c("black","darkgrey"), bty="n", cex=1.2)
...
cp <- function(n, alpha) qt(p= 1-alfa/2, df = n-1)
## Fig S1
...
par(cex.main = 1.5, lwd=2,
    ...
    oma=c(3,3,0,0))
p1b(t.results, main = "t-test", xlab="", ylab="", cex=0.25,
...
par(cex.main = 1.5, lwd=2,
    ...
    cex.lab = 1.25, font.lab = 2, cex.axis = 1.2, bty = "l", las = 1, mfrow=c(3,2),
    oma=c(3,3,0,0))
p3b(t.results, main = "t-test", xlab="", ylab="", cex=0.25, xlim =c(0.1,4),
    colours=rainbow(3, alpha=0.2),
    log="xy",
    pos.leg="topright")
p3b(cor.results, main = "Correlation", 
    legend=FALSE, xlab="", ylab="", cex=0.25, xlim =c(0.1,4),
    colours=rainbow(3, alpha=0.2), log="xy")
...
par(cex.main = 1.5, lwd=2,
    ...
    cex.lab = 1.25, font.lab = 2, cex.axis = 1.2, bty = "l", las = 1, mfrow=c(3,2),
    oma=c(3,3,0,0))
p4b(t.results, main = "t-test", xlab="", ylab="", cex=0.25,
    ylim=c(1e-4,1), xlim =c(0.1,4),
    colours=rainbow(3, alpha=0.2),
    log="xy", pos.leg="bottomleft")
p4b(cor.results, main = "Correlation", 
    legend=FALSE, xlab="", ylab="", cex=0.25, xlim =c(0.1,4), ylim=c(1e-4,1) ,
    colours=rainbow(3, alpha=0.2),
    log="xy")
